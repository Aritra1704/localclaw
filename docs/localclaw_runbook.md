...
- Phase 14: in progress. Persistent chat context is live, and structured `chat_summary_v1` summaries plus preference extraction now persist in PostgreSQL; iterative task-contract refinement is still open.
